...
//{
//    XMVECTOR vEnemyPos = XMLoadFloat3(&transform_.position_);
...
//
//        //プレイヤーの位置
//        XMVECTOR EnemyPos = vEnemyPos - vEnemyPos;
//        XMVector3Normalize(EnemyPos);
//
//        //Downとプレイヤーの外積を求める
//        XMVECTOR vDot = XMVector3Dot(Down, EnemyPos);
...
//
//        //プレイヤーの位置
//        XMVECTOR EnemyPos = vBossPos - vEnemyPos;
//        XMVector3Normalize(EnemyPos);
//
//        //Downとプレイヤーの外積を求める
//        XMVECTOR vDot = XMVector3Dot(Down, EnemyPos);
...
//
//        //プレイヤーの位置
//        XMVECTOR EnemyPos = vBoss2Pos - vEnemyPos;
//        XMVector3Normalize(EnemyPos);
//
//        //Downとプレイヤーの外積を求める
//        XMVECTOR vDot = XMVector3Dot(Down, EnemyPos);
